#!/usr/bin/env python3
"""Parse the three TMA DC area points and emit a compact comparison CSV."""
...
def main() -> None:
    ...
    names = [item["name"] for item in configs["variants"] if item["measured"]]
