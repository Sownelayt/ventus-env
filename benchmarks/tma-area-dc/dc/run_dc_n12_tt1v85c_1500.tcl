# Standalone Ventus TMA area synthesis at TSMC N12 TT 1.0 V 85 C, 1.5 GHz.
...
set variant [getenv_default "VARIANT" "tma_v3_1_area"]
...
puts "============================================================"
puts "Ventus TMA V3.1 standalone DC area sweep"
...
# Preserve only the blocks needed for useful area attribution. All variants
# use the same boundaries, so their deltas remain comparable.
...
puts "INFO: TMA V3.1 N12 TT 1.0V 85C 1.5GHz synthesis finished"
exit
