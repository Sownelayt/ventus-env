...
export SYNTH_FREQ_MHZ=${SYNTH_FREQ_MHZ:-1600}
export REPORT_FREQ_MHZ=${REPORT_FREQ_MHZ:-1600}
export MAX_AREA=${MAX_AREA:-90000}
export MAX_CORES=${MAX_CORES:-12}
export DC_TIMEOUT_SECONDS=${DC_TIMEOUT_SECONDS:-0}
export VARIANT=${VARIANT:-v3_5_release_40x6_desc4}
...
LOG=${DC_LOG:-dc_${VARIANT}_n12_tt1v85c_1600.log}
printf 'RUNNING\n' > dc_exit.status
set +e
if [ "$DC_TIMEOUT_SECONDS" -eq 0 ]; then
  "$DC_SHELL" -64bit -f dc/run_dc_n12_tt1v85c_1600.tcl \
    > "$LOG" 2>&1
else
