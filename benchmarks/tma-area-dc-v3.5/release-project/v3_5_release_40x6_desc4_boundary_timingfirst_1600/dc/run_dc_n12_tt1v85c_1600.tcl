...
set max_area [getenv_default "MAX_AREA" 90000.0]
...
# This is a timing-first diagnostic, not an area-minimization run.  The
# 90k-cell cap leaves modest upsizing/buffering headroom over the 1.5 GHz
# boundary result while still preventing an unbounded timing-at-any-area map.
...
puts "INFO: TMA V3.5 N12 TT 1.0V 85C 1.6GHz timing-first synthesis finished"
exit
