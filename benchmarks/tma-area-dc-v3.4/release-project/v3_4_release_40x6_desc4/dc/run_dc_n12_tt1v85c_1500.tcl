# Standalone Ventus TMA V3.4 synthesis at TSMC N12 TT 1.0 V 85 C.
...
set variant [getenv_default "VARIANT" "v3_4_release_40x6_desc4"]
...
puts "Ventus TMA V3.4 DC: $variant top=$design_name"
...
puts "INFO: TMA V3.4 N12 TT 1.0V 85C 1.5GHz synthesis finished"
exit
